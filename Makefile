...
EXTRA_DIST = taucs.pdf tsnnls_tester.xcode ./test_files/full_example_200 ./test_files/sparse_tests external_libraries testfull testsparse
SUBDIRS = tsnnls 
TESTS = testfull testsparse
subdir = .
...
distdir: $(DISTFILES)
	$(am__remove_distdir)
	mkdir $(distdir)
	$(mkinstalldirs) $(distdir)/./test_files
